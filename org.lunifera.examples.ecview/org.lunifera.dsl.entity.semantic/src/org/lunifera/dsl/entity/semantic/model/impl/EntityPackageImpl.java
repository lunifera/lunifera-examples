...
public class EntityPackageImpl extends EPackageImpl implements EntityPackage {
	...
	public EReference getLProperty_Opposite() {
		return (EReference)lPropertyEClass.getEStructuralFeatures().get(8);
	}
	...
	public EReference getLProperty_Multiplicity() {
		return (EReference)lPropertyEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EReference getLIndex_Properties() {
	...
	public void createPackageContents() {
		...
		createEReference(lIndexEClass, LINDEX__PROPERTIES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getLIndex_Unique(), ecorePackage.getEBoolean(), "unique", null, 0, 1, LIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLIndex_Name(), ecorePackage.getEString(), "name", null, 0, 1, LIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLIndex_Properties(), this.getLEntityProp(), null, "properties", null, 0, -1, LIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
